...
export const handler = async (
  ...
  return ctx.render({ ...post, html, headings });
};
    ...
    <div class='bg-black text-white min-h-screen'>
      <Head>
        ...
        <meta
          ...
          }/api/thumbnail?title=${encodeURIComponent(props.data.title)}`}
        />
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: sass('./article.scss').to_string('compressed').toString(),
          }}
        />
      </Head>
      <Nav />
      <div class='px-6 xs:px-10 mx-auto max-w-screen-xl'>
        ...
        <section class='flex flex-col-reverse slg:grid slg:grid-cols-[minmax(1px,1fr)18rem]'>
          <div class='my-8 max-w-full mr-10'>
            <article class='w-full max-w-full'>
              <img
                class='w-full'
                src={`/api/thumbnail?title=${encodeURIComponent(
                  props.data.title
                )}`}
              />
              <div
          ...
          <div class='mt-10 mb-6 slg:m-0 slg:sticky slg:top-48 slg:self-start'>
            ...
            <div class='flex flex-col mt-2 pl-6 border-l border-gray-900'>
